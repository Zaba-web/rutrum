...
class Property{ // main class for inline styling
    ...
    get(el,name){
        ...
        $("[data-control-target='rut-elem-prop-"+name+"']").val($(el).css(name));
    }
